...
namespace UILogic
{
    public abstract class AudioVisualizerBase
    {
        ...
        public abstract void AudioVisualizerPaint();

        protected abstract void DrawGridLines(int imageHeight);

        protected abstract void DrawTimeLine(int imageHeight);

        protected abstract void DrawParagraph(Paragraph paragraph);

        protected abstract void SetCursorSplit();

        protected abstract void SetCursorNormal();
        protected abstract void SetCursorHand();
        ...
        protected const int MinimumSelectionMilliseconds = 100;

        protected long _buttonDownTimeTicks;
        protected int _mouseMoveLastX = -1;
        protected int _mouseMoveStartX = -1;
        protected double _moveWholeStartDifferenceMilliseconds = -1;
        protected int _mouseMoveEndX = -1;
        protected bool _mouseDown;
        protected Paragraph _oldParagraph;
        protected Paragraph _mouseDownParagraph;
        protected MouseDownParagraphType _mouseDownParagraphType = MouseDownParagraphType.Start;
        protected List<Paragraph> _displayableParagraphs = new List<Paragraph>();
        protected List<Paragraph> _allSelectedParagraphs = new List<Paragraph>();
        protected Paragraph _selectedParagraph;
        protected Paragraph _prevParagraph;
        protected Paragraph _nextParagraph;
        protected bool _firstMove = true;
        protected double _currentVideoPositionSeconds = -1;
        protected WavePeakData _wavePeaks;
        protected Subtitle _subtitle;
        protected bool _noClear;
        protected double _gapAtStart = -1;

        protected SpectrogramData _spectrogram;
        protected const int SpectrogramDisplayHeight = 128;
        ...
        public void FireOnNewSelectionRightClicked(ParagraphEventArgs e)
        {
            if (OnNewSelectionRightClicked != null)
            {
                OnNewSelectionRightClicked.Invoke(this, e);
            }
        }

        public event ParagraphEventHandler OnParagraphRightClicked;

        public void FireOnParagraphRightClicked(ParagraphEventArgs e)
        {
            if (OnParagraphRightClicked != null)
            {
                OnParagraphRightClicked.Invoke(this, e);
            }
        }
        ...
        public void FireOnTimeChanged(ParagraphEventArgs e)
        {
        ...
        protected double _wholeParagraphMinMilliseconds;
        protected double _wholeParagraphMaxMilliseconds = double.MaxValue;
        ...
        private double _verticalZoomFactor = 1.0;
        // 1.0=no zoom
        ...
        protected List<double> _sceneChanges = new List<double>();
        ...
        protected bool _showSpectrogram;
        ...
        protected double _startPositionSeconds;
...
//TODO:            MouseWheel += WaveformMouseWheel;
...
//            InsertAtVideoPositionShortcut = Utilities.GetKeys(Configuration.Settings.Shortcuts.MainWaveformInsertAtCurrentPosition);
        ...
        public void SetPosition(double startPositionSeconds, Subtitle subtitle, double currentVideoPositionSeconds, int subtitleIndex, List<int> selectedIndexes)
        {
        ...
        protected class IsSelectedHelper
        {
            ...
            protected void FindNextSelection(int position)
            {
            ...
            protected struct SelectionRange
            {
        ...
        //        public void AudioVisualizerPaint() //object sender, PaintEventArgs e)
        //        {
        ...
        //        protected void DrawGridLines(int imageHeight)
        //        {
        ////            if (_wavePeaks == null)
        ////            {
        ...
        //        protected void DrawTimeLine(int imageHeight)
        //        {
        ...
        protected static string GetDisplayTime(double seconds)
        {
        ...
        //  protected void DrawParagraph(Paragraph paragraph)
        //        {
        ...
        protected double RelativeXPositionToSeconds(int x)
        {
            return StartPositionSeconds + ((double)x / _wavePeaks.SampleRate) / _zoomFactor;
        }

        protected int SecondsToXPosition(double seconds)
        {
            return (int)Math.Round(seconds * _wavePeaks.SampleRate * _zoomFactor);
        }

        protected int SecondsToSampleIndex(double seconds)
        {
            return (int)Math.Round(seconds * _wavePeaks.SampleRate);
        }

        protected double SampleIndexToSeconds(int index)
        {
            return (double)index / _wavePeaks.SampleRate;
        }

        //        private void WaveformMouseDown(object sender, MouseEventArgs e)
        protected void WaveformMouseDown(object sender, Point e, bool isMouseButtonLeft, bool isMouseButtonRight)
        {
            if (_wavePeaks == null)
                return;
            ...
            if (isMouseButtonLeft)
            {
                ...
                else
                {
                    ...
                    if (p != null)
                    {
                        ...
                        SetCursorHand(); // Cursor = Cursors.Hand;
                        SetMinAndMax();
                    }
        ...
        protected void SetMinMaxViaSeconds(double seconds)
        {
        ...
        protected void SetMinAndMaxMoveStart()
        {
            _wholeParagraphMinMilliseconds = 0;
            _wholeParagraphMaxMilliseconds = double.MaxValue;
            if (_subtitle != null && _mouseDownParagraph != null)
        ...
        protected void SetMinAndMaxMoveEnd()
        {
            _wholeParagraphMinMilliseconds = 0;
            _wholeParagraphMaxMilliseconds = double.MaxValue;
            if (_subtitle != null && _mouseDownParagraph != null)
        ...
        protected bool SetParagrapBorderHit(int milliseconds, List<Paragraph> paragraphs)
        {
            foreach (Paragraph p in paragraphs)
            {
        ...
        protected Paragraph GetParagraphAtMilliseconds(int milliseconds)
        {
            Paragraph p = null;
        ...
        protected bool SetParagrapBorderHit(int milliseconds, Paragraph paragraph)
        {
            if (paragraph == null)
                return false;
        ...
        protected bool AllowMovePrevOrNext
        {
            get
            {
                return false;
        ...
        protected void WaveformMouseMove(object sender, Point e, bool mouseLeftButton, bool isModifierKeysOnlyAlt)
        {
            if (_wavePeaks == null)
                return;
            ...
            else if (mouseLeftButton)
            {
                ...
                if (_mouseDown)
                {
                    if (_mouseDownParagraph != null)
                    {
                        ...
                        if (!isModifierKeysOnlyAlt) // ModifierKeys != Keys.Alt)
                        {
        ...
        protected bool IsParagrapBorderHit(int milliseconds, List<Paragraph> paragraphs)
        {
            foreach (Paragraph p in paragraphs)
            {
        ...
        protected bool IsParagrapBorderHit(int milliseconds, Paragraph paragraph)
        {
            if (paragraph == null)
                return false;
        ...
        protected bool IsParagrapBorderStartHit(double milliseconds, double startMs)
        {
            return Math.Abs(milliseconds - (startMs - 5)) - 10 <= ClosenessForBorderSelection;
        }

        protected bool IsParagrapBorderEndHit(double milliseconds, double endMs)
        {
        ...
        protected void WaveformMouseDoubleClick(object sender, Point e, bool mouseButtonLeft)
        {
            if (_wavePeaks == null)
                return;
        ...
        protected static bool IsParagrapHit(int milliseconds, Paragraph paragraph)
        {
            if (paragraph == null)
                return false;
        ...
        protected void WaveformMouseClick(object sender, Point e, bool mouseButtonLeft, bool shiftDown, bool controlDown, bool altDown)
        {
            if (mouseButtonLeft && OnSingleClick != null)
            {
                ...
                {
                    if (shiftDown && _selectedParagraph != null)
                    {
                        double seconds = RelativeXPositionToSeconds(e.X);
                        var milliseconds = (int)(seconds * TimeCode.BaseUnit);
                    ...
                    if (controlDown && _selectedParagraph != null)
                    {
                        double seconds = RelativeXPositionToSeconds(e.X);
                        var milliseconds = (int)(seconds * TimeCode.BaseUnit);
                        if (_mouseDownParagraphType == MouseDownParagraphType.None || _mouseDownParagraphType == MouseDownParagraphType.Whole)
                    ...
                    if (controlDown && shiftDown && _selectedParagraph != null)
                    {
                        double seconds = RelativeXPositionToSeconds(e.X);
                        if (_mouseDownParagraphType == MouseDownParagraphType.None || _mouseDownParagraphType == MouseDownParagraphType.Whole)
                        {
                    ...
                    if (altDown && _selectedParagraph != null)
                    {
                        double seconds = RelativeXPositionToSeconds(e.X);
                        var milliseconds = (int)(seconds * TimeCode.BaseUnit);
                        if (_mouseDownParagraphType == MouseDownParagraphType.None || _mouseDownParagraphType == MouseDownParagraphType.Whole)
...
//                    });
        ...
        protected void DrawSpectrogram()
        {
...
//            }
        ...
        protected double GetAverageVolumeForNextMilliseconds(int sampleIndex, int milliseconds)
        {
        ...
        public void GenerateTimeCodes(Subtitle subtitle, double startFromSeconds, int blockSizeMilliseconds, int minimumVolumePercent, int maximumVolumePercent, int defaultMilliseconds)
        {
        ...
        protected bool EndParagraphDueToLowVolume(Subtitle subtitle, int blockSizeMilliseconds, double silenceThreshold, int begin, bool subtitleOn, int i)
        {
            double avgVol = GetAverageVolumeForNextMilliseconds(i, blockSizeMilliseconds);
            if (avgVol < silenceThreshold)
            {
